    ...
    <xsl:template match="/dir">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-ES" dir="ltr" lang="es-ES"> 
            <head profile="http://gmpg.org/xfn/11"> 
                ...
                <title>
                    <xsl:value-of select="name" /> - Nekomuk
                </title>
                    ...
                    <div class="files">
                        ...
                        <div class="filediv dir">
                            <a href="../index.xml">
                                <img class="icon" alt="[Up]">
                                    <xsl:attribute name="src">
                                        <xsl:value-of select="$root_level"/>../../static/icons/up_level.png
                                    </xsl:attribute>
                                </img>
                            </a>
                            <a href="../index.xml"></a>
                        ...
                        <xsl:for-each select="dirs/dir">
                            ...
                            <div class="filediv dir">
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="url"/>/index.xml
                                    </xsl:attribute>
                                    <img class="icon" alt="[Dir]">
                                        <xsl:attribute name="src">
                                            <xsl:value-of select="$root_level" />../../static/icons/<xsl:value-of select="icon" />
                                        </xsl:attribute>
                                    </img>
                                </a>
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="quote_name"/>/index.xml
                                    </xsl:attribute>
